        ...
        <table>
            <tr>
                ...
                <td style="width: 60%;">
                    ...
                    <form action="includes/editUser.inc.Admin.php" method="POST" enctype="multipart/form-data">
                            <label for="fname">User ID</label>
                            <input type="text" id="fname" name="id"  value="<?php echo $data["usersId"]  ?>  "disabled >
                            
                            <label for="fname">User Type</label>
                            <input type="text" id="fname" name="uid"  value="<?php echo $data["userType"]  ?>" disabled>

                            <label for="fname">User Name</label>
                            <input type="text" id="fname" name="uid"  value="<?php echo $data["usersUid"]  ?>" >

                            <label for="lname">Name</label>
                            <input type="text" id="lname" name="name"  value="<?php echo $data["usersName"]  ?>">

                            <label for="email">Your Email</label>
                            <input type="text" id="yemail" name="email"  value="<?php echo $data["usersEmail"]  ?>" >

                            <label for="nic">Your NIC</label>
                            <input type="text" id="mobilenumber" name="nic"  value="<?php echo $data["NIC"]  ?>">

                            <label for="phone">Mobile Number</label>
                            <input type="text" id="mobilenumber" name="phone"  value="<?php echo $data["phone"]  ?>" placeholder="Enter Mobile Number..">

                            <label for="address">Address</label>
                            <input type="text" id="address" name="address"  value="<?php echo $data["address"] ;  ?>" placeholder="Enter Address..">

                            <?php
                            
                            $_SESSION["temp"] = $data["usersId"];
